...
if df is not None:
    ...
    **Conclusion:**
    ...
    ipip_items = [
        ...
        ("I get stressed out easily when things go wrong.", "N_total", True),
        ...
        ("I am relaxed most of the time, even under pressure.", "N_total", False),
        ...
        ("I worry about things more than I should.", "N_total", True),
        ...
        ("I seldom feel blue or down for long.", "N_total", False),
        ...
        ("I am easily disturbed by small problems.", "N_total", True),
        ...
        ("I get upset easily and show it.", "N_total", True),
        ...
        ("I change my mood a lot over the day.", "N_total", True),
        ...
        ("I have frequent mood swings without much warning.", "N_total", True),
        ...
        ("I get irritated easily by small annoyances.", "N_total", True),
        ...
        ("I often feel blue or down.", "N_total", True),
